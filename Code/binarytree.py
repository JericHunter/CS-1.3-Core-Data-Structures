...
class BinaryTreeNode(object):
    ...
    def height(self):
        ...
        O(n) because we have to traverse every node"""
...
class BinarySearchTree(object):
    ...
    def height(self):
        ...
        TODO: Best and worst case running time: O(n) because we have to traverse every node"""
    ...
    def contains(self, item):
        ...
        O(1) item is at root
        O(h) h is height of the tree so we would haver to iterate to the deepest node looking for the item"""
    ...
    def _find_node_iterative(self, item):
        ...
        O(h) With H being the height of the BST, we would have to traverse to the height of the tree."""
    ...
    def _traverse_in_order_recursive(self, node, visit):
        ...
        O(n*v) because we need to look through every item
    ...
    def _traverse_pre_order_recursive(self, node, visit):
        ...
        Start at the given node and visit each node with the given function.
        O(n) because we need to look through every item
        TODO: Memory usage: ??? Why and under what conditions?"""
        visit(node.data)
        if node.left:
