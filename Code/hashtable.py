...
class HashTable(object):
    ...
    def keys(self):
        ...
        Best and worst case running time: O(n) because we have to traverse all items in each bucket"""
    ...
    def contains(self, key):
        ...
        Worst case running time: O(l) - l=load factor, we maintain a low load factor"""
