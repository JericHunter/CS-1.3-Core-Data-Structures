...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        # ...
        assert contains('n', '\n') is False  # escape character
        assert contains('abc', 'zbc') is False  # second letter but not others
    ...
    def test_contains_with_complex_patterns(self):
        ...
        # ...
        assert contains('borrrrrre', 'orr') is True
        assert contains('borrrre', 'rrrre') is True
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        # ...
        assert find_index('Darth Vader', 'Vader') == 6
        assert find_index('Darth Vader', 'er') == 9
        assert find_index('Darth Vader', 'ade') == 7
        assert find_index('Darth Vader', 'h V') == 4
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        # ...
        assert find_index('Dark side', 'sdie') is None
        assert find_index('Dark side', 'Darth') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        # You'll need a lot more than this to test your algorithm's robustness
        # ...
        assert find_index('borrrrrre', 'orr') == 1
        assert find_index('borrrre', 'rrrre') == 2
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        # ...
        assert find_all_indexes('Darth Vader', 'Vader') == [6]
        assert find_all_indexes('Darth Vader', 'er') == [9]
        assert find_all_indexes('Darth Vader', 'ade') == [7]
        assert find_all_indexes('Darth Vader', 'h V') == [4]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        # ...
        assert find_all_indexes('Dark side', 'sdie') == []
        assert find_all_indexes('Dark side', 'Darth') == []
